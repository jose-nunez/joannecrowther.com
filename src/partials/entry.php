...
<article id="post-<?php the_ID(); ?>" <?php post_class('entry'); ?>>
	<header class="entry-header">
		...
		?>
			<div class="thumbnail" style="background-image:url(<?php echo get_template_directory_uri() ?>/img/frame_1_white.png),url(<?php echo get_the_post_thumbnail_url(); ?>);<?php echo $bkgpos.$bkgheight; ?>"></div>	
		<?php endif; ?>
	...
	<?php get_template_part( 'partials/entry/entry', ( is_archive() || is_search() ? 'summary' : 'content' ) ); ?>
